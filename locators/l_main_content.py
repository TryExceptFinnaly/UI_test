...
class MainContentPageLocators:
    ...
    # USER_DATA_FOOTER_ROLE = (By.XPATH, "//div[@class='footer']/div[@class='container-fluid']/p/text()[1]")
    # USER_DATA_FOOTER_MO = (By.XPATH, "//div[@class='footer']/div[@class='container-fluid']/p/text()[3]")
    # USER_DATA_FOOTER_DEPARTMENT = (By.XPATH, "//div[@class='footer']/div[@class='container-fluid']/p/text()[5]")
    # USER_DATA_FOOTER_ROOM = (By.XPATH, "//div[@class='footer']/div[@class='container-fluid']/p/text()[7]")
